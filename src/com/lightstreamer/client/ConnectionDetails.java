...
public class ConnectionDetails {
  ...
  ConnectionDetails(InternalConnectionDetails internal) {
   ...
   */
  public synchronized void setAdapterSet(@Nullable String adapterSet) {
    this.internal.setAdapterSet(adapterSet);
  }
   ...
   */
  public synchronized void setServerAddress(@Nullable String serverAddress) {
    this.internal.setServerAddress(serverAddress);
  }
   ...
   */
  public synchronized void setUser(@Nullable String user) {
  ...
  public synchronized void setPassword(@Nullable String password) {
    this.internal.setPassword(password);
  }
