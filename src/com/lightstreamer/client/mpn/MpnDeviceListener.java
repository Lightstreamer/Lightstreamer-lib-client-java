...
public interface MpnDeviceListener {
    ...
    /**
     * Event handler called when the MpnDeviceListener instance is added to an MPN device object through {@link MpnDeviceInterface#addListener(MpnDeviceListener)}.<BR>
     * This is the first event to be fired on the listener.
     * 
     * @param device The MPN device object this instance was added to.
     */
    public void onListenStart(@Nonnull MpnDeviceInterface device);
    
    /**
     * Event handler called when the MpnDeviceListener instance is removed from an MPN device object through {@link MpnDeviceInterface#removeListener(MpnDeviceListener)}.<BR>
     * This is the last event to be fired on the listener.
     * 
     * @param device The MPN device object this instance was removed from.
     */
    public void onListenEnd(@Nonnull MpnDeviceInterface device);
     ...
     * 
     * @see MpnDeviceInterface#getStatus()
     * @see MpnDeviceInterface#getStatusTimestamp()
     */
